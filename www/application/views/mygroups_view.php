             ...
             foreach ($vals['groups'] as $arr_group){
                 ...
                 if(!empty($price_to_group) AND is_array($price_to_group)){
                     for($i=1; $i<10; $i++){
                         ...
                         $pay_month .= "<div class='block_pay_month_head'>".$month."<div class='block_pay_month' ".$style.">".$pr."</div></div>";
                     }
                 }
                 $abons .= "<div class='abon'>
                                ...
                                <div class='abon_info'>
                                    ...
                                    <div calass = 'block_price_month'>".
                                        ...
                                        ."<div class = 'bay_mont'>
                                            <form method='post'>
                                                <label>Кол-во месяцев к оплате: <input type='text' name = 'for_bill' id='amount-".$id_abon."' value='1'></label>
